...
const Header = () => {
    ...
    if (user) {
        menuitem.push({ to: '/home', data: 'Home' },
            { to: '/addService', data: "Add Service" }, { to: '/myReview', data: 'MyReview' }, { to: "/blog", data: "Blog" }, { to: "/service", data: "Service" })
    } else {
        menuitem.push({ to: '/home', data: 'Home' }, { to: "/blog", data: "Blog" }, { to: "/service", data: "Service" })
    }
    return (
                    ...
                    <div className="mx-auto max-w-7xl px-2 sm:px-6 lg:px-8">
                        <div className="relative flex h-16 items-center justify-between">
                            ...
                            <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
                                <h1 className="text-2xl">Exercise-with-Arif</h1>
